...
{
    /**
     * @Route("/", name="accept_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="accept_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="accept_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="accept_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="accept_delete", methods={"DELETE"})
     */
