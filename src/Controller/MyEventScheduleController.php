...
/**
 * @Route("/my/event/schedule")
 */
class MyEventScheduleController extends AbstractController
{
    /**
     * @Route("/", name="my_event_schedule_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="my_event_schedule_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="my_event_schedule_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="my_event_schedule_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="my_event_schedule_delete", methods={"DELETE"})
     */
